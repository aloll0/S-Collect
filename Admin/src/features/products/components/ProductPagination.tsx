...
export const ProductPagination = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 py-4 border-t border-gray-100 bg-white text-sm text-gray-500">
      {/* Item count summary */}
      <div>
        {t('productsListing.pagination.showing', {
          start: startItem,
          end: endItem,
          total: totalItems,
        })}
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button
          ...
          onClick={() => onPageChange(currentPage + 1)}
          className="p-1.5 rounded-lg border cursor-pointer border-gray-200 text-gray-600 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
