          ...
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="bg-gray-50/80 border-b border-gray-100 text-gray-400">
                <th className="px-5 py-3.5 text-start font-semibold">Vendor</th>
                <th className="px-5 py-3.5 text-start font-semibold">Revenue</th>
                <th className="px-5 py-3.5 text-start font-semibold">Orders</th>
                <th className="px-5 py-3.5 text-start font-semibold">Status</th>
                <th className="px-5 py-3.5 text-end font-semibold">Action</th>
              </tr>
            </thead>
              ...
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] text-gray-500 font-medium">
                    <span className="font-bold text-gray-900">SAR {v.revenue.toLocaleString()}</span> — {v.orders} orders
                  </p>
                </div>
              </div>
              <button
