  ...
  return (
    <div className="flex-1 overflow-y-auto bg-gray-50/80 min-h-screen">
      ...
      <div className="sidebar-page-container py-6">
        ...
        {isMobile ? (
          /* Mobile Stacked View (Matching Screenshot 2) */
          <div className="space-y-4">
            {/* 1. Order Info */}
            <div className="bg-white rounded-2xl border border-gray-200/80 p-4 shadow-2xs">
              <h2 className="font-bold text-gray-900 text-sm mb-3">Order Info</h2>
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-700">Credit Card (Mada)</span>
                </div>
            ...
            {/* 2. Customer Details */}
            <div className="bg-white rounded-2xl border border-gray-200/80 p-4 shadow-2xs">
              <h2 className="font-bold text-gray-900 text-sm mb-3">Customer Details</h2>
              <div className="space-y-1.5 text-xs">
                <p className="font-bold text-gray-900 text-sm">Yousef Al-Harbi</p>
                <p className="text-gray-500">Email: y.alharbi@gmail.com</p>
                <p className="text-gray-500">Phone: +966 50 123 4567</p>
              </div>
            </div>

            {/* 3. Shipping Address */}
            <div className="bg-white rounded-2xl border border-gray-200/80 p-4 shadow-2xs">
              <h2 className="font-bold text-gray-900 text-sm mb-3">Shipping Address</h2>
            ...
            {/* 4. Order Timeline */}
            <div className="bg-white rounded-2xl border border-gray-200/80 p-4 shadow-2xs">
              <h2 className="font-bold text-gray-900 text-sm mb-4">Order Timeline</h2>
              <div className="space-y-4 relative pl-5">
                ...
                <div className="relative">
                  <span className="absolute -left-5 top-1 w-3 h-3 rounded-full bg-emerald-500 ring-4 ring-white" />
                  <p className="font-bold text-gray-900 text-xs">Order Placed</p>
                  <p className="text-[11px] text-gray-400">Oct 24, 2026 - 09:41 AM</p>
                </div>
                {/* Step 2 */}
                <div className="relative">
                  <span className="absolute -left-5 top-1 w-3 h-3 rounded-full bg-emerald-500 ring-4 ring-white" />
                  <p className="font-bold text-gray-900 text-xs">Payment Confirmed</p>
                  <p className="text-[11px] text-gray-400">Oct 24, 2026 - 09:43 AM</p>
                </div>
                {/* Step 3 */}
                <div className="relative">
                  <span className="absolute -left-5 top-1 w-3 h-3 rounded-full bg-blue-600 ring-4 ring-white" />
                  <p className="font-bold text-blue-600 text-xs">Processing</p>
                  <p className="text-[11px] text-gray-400">Oct 24, 2026 - 10:15 AM</p>
                </div>
                {/* Step 4 */}
                <div className="relative">
                  <span className="absolute -left-5 top-1 w-3 h-3 rounded-full bg-gray-300 ring-4 ring-white" />
                  <p className="font-medium text-gray-400 text-xs">Shipped</p>
                  <p className="text-[11px] text-gray-400">Pending Fulfillment</p>
                </div>
              </div>
            </div>
            ...
            {/* 5. Order Items */}
            <div className="bg-white rounded-2xl border border-gray-200/80 p-4 shadow-2xs">
              <h2 className="font-bold text-gray-900 text-sm mb-3">Order Items</h2>
              <div className="flex items-center justify-between text-xs">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-[11px]">Vendor: Al-Falah Crafts</p>
                  </div>
                </div>
            ...
            {/* 6. Summary */}
            <div className="bg-white rounded-2xl border border-gray-200/80 p-4 shadow-2xs">
              <h2 className="font-bold text-gray-900 text-sm mb-3">Summary</h2>
              <div className="space-y-2 text-xs">
            ...
            <div className="bg-white rounded-2xl border border-gray-200/80 p-4 shadow-2xs">
              <div className="flex items-center justify-between mb-3">
                <h2 className="font-bold text-gray-900 text-sm">Sub-Orders</h2>
          ...
          /* Desktop Grid Layout (Matching Screenshot 1) */
          <div className="grid grid-cols-1 xl:grid-cols-[1fr_360px] gap-6 items-start">
            {/* Left Column */}
            <div className="space-y-6">
              {/* 1. Order Items Table */}
              <div className="bg-white rounded-2xl border border-gray-200/80 p-5 shadow-2xs">
                <h2 className="font-bold text-gray-900 text-base mb-4">Order Items</h2>
                <div className="overflow-x-auto">
                  <table className="w-full text-start text-xs border-collapse">
                    <thead>
                      <tr className="border-b border-gray-100 text-gray-400 font-medium pb-2">
                        <th className="text-start pb-3 font-medium">Product</th>
                        <th className="text-center pb-3 font-medium">Qty</th>
                        <th className="text-end pb-3 font-medium">Price</th>
                        <th className="text-end pb-3 font-medium">Subtotal</th>
                      </tr>
                    </thead>
                        ...
                        <td className="py-4 text-start">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-400 text-xs">Vendor: Al-Falah Crafts</p>
                            </div>
                          </div>
                        </td>
              ...
              {/* 2. Summary Card */}
              <div className="bg-white rounded-2xl border border-gray-200/80 p-5 shadow-2xs">
                <h2 className="font-bold text-gray-900 text-base mb-4">Summary</h2>
              ...
              <div className="bg-white rounded-2xl border border-gray-200/80 p-5 shadow-2xs space-y-6">
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  <h2 className="font-bold text-gray-900 text-base">Sub-Orders</h2>
                  <span className="text-xs text-gray-400 font-medium">3 items</span>
                </div>
                  ...
                  >
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full py-2 px-3 pr-8 rounded-xl border border-gray-200 text-xs font-mono text-gray-800 bg-gray-50/50 focus:outline-none focus:border-gray-900"
                          />
                          <button
                            type="button"
                        ...
                        <div key={idx} className="flex items-center justify-between text-xs">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-400 text-[11px]">Qty: {it.qty}</p>
                    ...
                    {sub.subtotal && (
                      <div className="pt-2 border-t border-gray-100 text-end text-xs space-y-0.5 text-gray-500">
                        <p>Subtotal: <span className="font-semibold text-gray-900">{sub.subtotal}</span></p>
                        <p>Shipping: <span className="font-semibold text-gray-900">{sub.shipping}</span></p>
                      </div>
                    )}
                  </div>
                ))}
                ...
                <div className="bg-rose-50 border border-rose-100 rounded-xl p-3.5 flex items-center gap-2 text-xs text-rose-600">
                  ...
                  <span>Some products in your order are out of stock. You can reorder without these items.</span>
                </div>

                {/* Sub-orders Total Summary */}
                <div className="pt-4 border-t border-gray-100 text-end text-xs space-y-1">
                  <p className="text-gray-500">Total Items: <span className="font-bold text-gray-900">EGP 1,650.00</span></p>
                  <p className="text-gray-500">Total Shipping: <span className="font-bold text-gray-900">EGP 40.00</span></p>
                  <p className="text-sm font-bold text-gray-900 pt-1">Grand Total: <span className="text-gray-900">EGP 1,690.00</span></p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white rounded-2xl border border-gray-200/80 p-5 shadow-2xs">
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-400">Payment Method:</span>
                    <span className="text-gray-600">Credit Card (Mada)</span>
                  </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200/80 p-5 shadow-2xs">
                ...
                <div className="space-y-5 relative pl-5">
                  ...
                  {/* Step 1 */}
                  <div className="relative">
                    <span className="absolute -left-5 top-1 w-3.5 h-3.5 rounded-full bg-emerald-500 ring-4 ring-white" />
                    <p className="font-bold text-gray-900 text-xs">Order Placed</p>
                    <p className="text-[11px] text-gray-400">Oct 24, 2026 - 09:41 AM</p>
                  </div>
                  {/* Step 2 */}
                  ...
                  {/* Step 3 */}
                  <div className="relative">
                    <span className="absolute -left-5 top-1 w-3.5 h-3.5 rounded-full bg-blue-600 ring-4 ring-white" />
                    <p className="font-bold text-blue-600 text-xs">Processing</p>
                    <p className="text-[11px] text-gray-400">Oct 24, 2026 - 10:15 AM</p>
                  </div>
                  {/* Step 4 */}
                  <div className="relative">
                    <span className="absolute -left-5 top-1 w-3.5 h-3.5 rounded-full bg-gray-300 ring-4 ring-white" />
                    <p className="font-medium text-gray-400 text-xs">Shipped</p>
                    <p className="text-[11px] text-gray-400">Pending Fulfillment</p>
                  </div>
                </div>
